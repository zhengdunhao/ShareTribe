...
import com.atm.chatonline.usermsg.ui.IndicatorFragmentActivity.TabInfo;
...
public class TitleIndicator extends LinearLayout implements View.OnClickListener,
    ...
    private static final int FOOTER_COLOR = 0x00FF00;
    ...
    private final int BSSEEID = 0x00FF00;
    ...
    protected void add(int index, String label, int icon, boolean hasTips) {
        View tabIndicator;
        if (index < 2) {
            tabIndicator = mInflater.inflate(R.layout.user_msg_title_flow_indicator, this, false);
        } else {
            tabIndicator = mInflater.inflate(R.layout.user_msg_title_flow_indicator_v2, this, false);
        }
