...
import com.atm.chatonline.usercenter.activity.usercenter.MyBbs;
...
public class PeoplePublishedNote extends BaseActivity implements OnClickListener{
	...
	private String tag ="PeoplePublishedNote";
		...
		handler = new Handler() {
			...
			public void handleMessage(Message msg) {
				...
				case 2:
					...
					Toast.makeText(PeoplePublishedNote.this.getApplicationContext(),
	...
	void initIntent(){
		try{
			...
			title.setText(friendNickName+"发布的帖子");
		}catch(Exception e){
			e.printStackTrace();
		}
	}
	...
	void initView(){
		noteAdapter = new NoteAdapter(PeoplePublishedNote.this,
		...
		plv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				// 传递essayid给帖子。
				Log.i(tag, "帖子被点击");
				ExtendsIntent intent = new ExtendsIntent(PeoplePublishedNote.this,
			...
			Thread thread = new Thread(new Runnable() {
				public void run() {
					bBSConnectNet = new BBSConnectNet("", friendID, bbsNums,
							"essay_publishedEssay.action", cookie);
